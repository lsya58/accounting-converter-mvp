...
| Yayoi | Yayoi Accounting AE 19 | 弥生インポート形式 direct export | Export evidence | 25 observed | no header observed | CP932 observed | 2000 observed | OBSERVED | private raw export observation | Medium for this one sample | 1仕訳のみ。正式YayoiInputAdapterや万能仕様へ昇格しない。 |
...
- 弥生会計AE19 direct exportの1仕訳サンプルで、25項目、CP932、CRLF、BOMなし、識別フラグ2000、ヘッダーなし、貸借一致候補をraw bytes/parserで観測した。
